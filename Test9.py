...
with sync_playwright() as p:
    ...
    search_box.focus()
    search_box.type('Data Justice', delay=100)
    time.sleep(5)
    page.locator('.dropdown-menu.active >> text="Data Justice"').click(force=True)
    time.sleep(5)   
    ...
    with open("Alltechjobs6.csv", "w", newline="", encoding="utf-8") as f:
        writer = csv.writer(f)
