...
with sync_playwright() as p:
    ...
    search_box.focus()
    search_box.type('Tech Policy/Law', delay=100)
    time.sleep(5)
    page.locator('.dropdown-menu.active >> text="Tech Policy/Law"').click(force=True)
    time.sleep(5)   
    ...
    with open("Alltechjobs4.csv", "w", newline="", encoding="utf-8") as f:
        writer = csv.writer(f)
